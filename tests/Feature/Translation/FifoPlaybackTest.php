...
it('renders custom FIFO playback controls without native audio volume UI', function () {
    ...
    Livewire::withCookie(AnonymousVisitor::COOKIE_NAME, $visitorId)
        ...
        ->assertSee('data-playback-icon-play', false)
        ->assertSee('data-playback-icon-stop', false)
        ->assertSee('data-playback-state="idle"', false)
        ->assertSee('title="Play speech"', false)
        ->assertSee('aria-label="Play speech"', false)
        ->assertSee('data-playback-icon-stop', false)
        ->assertDontSee('data-playback-icon-pause', false)
        ->assertDontSee('>Pause</', false)
        ->assertDontSee('data-playback-state="paused"', false)
