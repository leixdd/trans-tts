...
- **App:** Public English→Japanese chat translation page with Fish Audio TTS via Novita (queued turns, anonymous history, FIFO autoplay; see [README.md](README.md) for setup).
